  ...
  return (
    <section id='Skills'>
       <div className='bg-pink-300 p-5'>
        <div className='grid justify-items-center font-bold uppercase text-xl'>
            <h1>Skills</h1>
        </div>
        ...
        <div className='text-center text-white grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4'>
            <div className='bg-gray-700 justify-items-center m-5 p-2 rounded-lg'>
